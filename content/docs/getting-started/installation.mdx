...
<Tabs
	items={['Balatro Multiplayer Launcher', 'Windows', 'Mac', 'Linux/Steamdeck',]}>
	...
	<Tab value="Windows" className={'flex justify-center'}>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/iqTpHz5vZgA" loading="lazy" title="YouTube video player"
				frameBorder="0"
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
				allowFullScreen></iframe>
	</Tab>
	<Tab value="Mac" className={'flex justify-center'}>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/05Hs8f1t8eo" loading="lazy" title="YouTube video player"
				frameBorder="0"
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
				allowFullScreen></iframe>
	</Tab>
	<Tab value="Linux/Steamdeck" className={'flex justify-center'}>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/zaVy_AwojQk" loading="lazy" title="YouTube video player"
				frameBorder="0"
				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
				allowFullScreen></iframe>
	</Tab>
