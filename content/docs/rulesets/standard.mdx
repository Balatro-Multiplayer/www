	...
	<table>
		...
		<tr>
			...
			<td>
				<div className={'flex flex-col gap-1'}>
					...
					<span><Chance>1 in 4</Chance> chance to give your Nemesis <Money> $10</Money> in <Hands>PvP Blind</Hands></span>
				</div>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<Money>$1</Money> for every <Money>$3</Money> your Nemesis spent in the corresponding shop <Hands>last ante</Hands>
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				Gains <Mult>+4</Mult> Mult for every card your Nemesis <Hands>sold</Hands> since last <Hands>PvP Blind</Hands>,
		...
		<tr>
			...
			<td>
				<div className={'flex flex-col gap-1'}>
					<span>When eaten, <Mult>+2</Mult> discards and <Mult>+1</Mult> discard for your opponent for the next ante</span>
