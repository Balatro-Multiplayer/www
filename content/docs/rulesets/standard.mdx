...
<div className={'relative overflow-auto'}>
	<table>
		...
		<tr>
			...
			<td>
				<div className={'flex flex-col gap-1'}>
					<span>At the end of the next <Hands>PvP Blind</Hands>, consume this Joker and grant <Mult>+1</Mult> discard to you and <Mult>+2</Mult> discards to your Nemesis for the ante</span>
